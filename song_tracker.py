# Main file for the logic of the app
#
# This asks for a user's credentials and will begin tracking the listening time of 
# each song that the user listens to, on any device that they are running Spotify on. 
